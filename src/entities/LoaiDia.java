...
public class LoaiDia implements Serializable {
	...
	private Set<TuaDe> dsTuaDe = new HashSet<TuaDe>();

	public LoaiDia() {
		super();
	}

	public LoaiDia(TenLoaiDia tenLoaiDia, double giaThue, double phiTreHan, int thoiGianThue) {
		super();
	...
	public String toString() {
		return "LoaiDia [maLoaiDia=" + maLoaiDia + ", tenLoaiDia=" + tenLoaiDia + ", giaThue=" + giaThue
				+ ", phiTreHan=" + phiTreHan + ", thoiGianThue=" + thoiGianThue + "]";
	}
